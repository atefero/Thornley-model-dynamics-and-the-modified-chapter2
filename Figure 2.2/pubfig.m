...
fontsize = 17; % font sizes are scaled by this value. 2-3 is typical.

interpreter_style = 'Latex';
...
for i=fliplr(a)
   ...
   % Find histogram bars
    ...
    if isa (i,'matlab.graphics.illustration.Legend')
        ...
        % title
        set(get(i,'Title'),'FontSize',fontsize*1.1,'FontWeight',fweight,'FontName',myfont,'Color',fontcolor)
